            ...
            <div style="background: #ffffff; padding: 40px 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px;">
              ...
              <div style="background: #f8fafc; border-left: 4px solid #f59e0b; padding: 20px; margin: 30px 0; border-radius: 4px;">
                ...
                <ul style="color: #475569; padding-left: 20px; margin: 10px 0;">
                  ...
                  <li style="margin: 8px 0;">Set up online rent payments for convenience</li>
                </ul>
              </div>
              
      <div style="text-align: center; margin: 30px 0;">
        <a href="${SITE_URL}/dashboard" 
           style="display: inline-block; background: #1e293b; color: #ffffff; padding: 14px 32px; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 16px;">
          Go to Dashboard
        </a>
      </div>
              ...
              <div style="background: #fef3c7; border: 1px solid #fbbf24; padding: 15px; border-radius: 8px; margin: 20px 0;">
                <p style="margin: 0; color: #92400e; font-size: 14px;">
                  <strong>💡 Pro Tip:</strong> Download our mobile app for on-the-go access to all features!
                </p>
              </div>
              ...
              <p style="color: #64748b; font-size: 14px; margin: 20px 0 0 0;">
                Best regards,<br>
                <strong style="color: #1e293b;">The Ultimate Apartment Manager Team</strong>
              </p>
            </div>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e2e8f0; border-top: none; border-radius: 0 0 12px 12px;">
              ...
              <p style="color: #475569;">
                We've received your maintenance request and our team will address it shortly.
              </p>
              ...
              <div style="text-align: center; margin: 25px 0;">
                <a href="${SITE_URL}/dashboard/maintenance" 
                   style="display: inline-block; background: #1e293b; color: #ffffff; padding: 12px 28px; text-decoration: none; border-radius: 8px; font-weight: 600;">
                  View Request Status
                </a>
              </div>
              ...
              <p style="color: #64748b; font-size: 14px; margin: 0;">
                Thank you,<br>
                <strong style="color: #1e293b;">Ultimate Apartment Manager Team</strong>
              </p>
            </div>
          </body>
        </html>
